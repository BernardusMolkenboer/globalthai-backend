...
class Entity {
    ...
    static getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, app_1.default)(this.table).first().where("id", id);
        });
    }
    static getByColumn(column_1, value_1) {
        return __awaiter(this, arguments, void 0, function* (column, value, one = true) {
            let qb = (0, app_1.default)(this.table).where(column, value);
    ...
    static getByColumns(params_1) {
        return __awaiter(this, arguments, void 0, function* (params, one = true) {
            let qb = (0, app_1.default)(this.table).where(params);
            return one ? yield qb.first() : yield qb;
        });
    }
    static getQueryBuilder() {
        return (0, app_1.default)(this.table);
    }
    _save(data, table) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.id) {
                const id = yield (0, app_1.default)(table)
                    .where({ id: this.id })
                    .update(data)
                    .returning("id");
                return id[0];
                ...
                const id = yield (0, app_1.default)(table).insert(data).returning("id");
                this.id = id[0];
                return this.id;
            }
        });
    ...
    static linkLog(id, ids) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ids.forEach((logId) => __awaiter(this, void 0, void 0, function* () {
                params["log_id"] = logId;
                yield (0, app_1.default)(linkTable).insert(params);
            }));
        });
    }
